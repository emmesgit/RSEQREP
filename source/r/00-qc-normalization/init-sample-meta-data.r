...
####################################################################################
dta.rseqc.gc=read.table(paste(rseqc.dir,'/bam_gc_parsed.tab',sep=''),
...
####################################################################################
dta.rseqc.qc= read.table(paste(rseqc.dir,'/bam_qc_parsed.tab',sep=''),
		header=T,stringsAsFactors=F,sep='\t');
...
####################################################################################
dta.rseqc.jc= read.table(paste(rseqc.dir,'/bam_jc_parsed.tab',sep=''),
		header=T,stringsAsFactors=F,sep='\t');
...
####################################################################################
if (file.exists(paste(rseqc.dir,'/bam_rc_parsed.tab',sep=''))) {
	dta.rseqc.rc= read.table(paste(rseqc.dir,'/bam_rc_parsed.tab',sep=''),
		header=T,stringsAsFactors=F,sep='\t');
