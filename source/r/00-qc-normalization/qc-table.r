...
for(v in 1:length(varFlags)) {
	...
	for (s in 1:length(spcFlags)) {
		...
		## print latex table
		x = xtable(res,caption=paste('Summary human reference ',varLabls[v],' alignment statistics for study samples (',spcLabl,')',sep=''),align=c('p{2.1in}','p{0.35in}','p{0.35in}','p{0.38in}','p{0.38in}','p{0.35in}','p{0.38in}','p{0.3in}','p{0.3in}','p{0.3in}'),digits=2,
